    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('league', models.CharField(choices=[('Bronze', 'Bronze'), ('Silver', 'Silver'), ('Gold', 'Gold'), ('Platinum', 'Platinum'), ('Diamond', 'Diamond'), ('Master', 'Master'), ('Grand Master', 'Grand Master')], default='Bronze', max_length=255, verbose_name='league')),
